...
public static class FastFont1
{
    ...
    public static Font GetDefaultFont(string? fontName = null, float fontSize = 9.0f, FontStyle style = FontStyle.Regular, GraphicsUnit unit = GraphicsUnit.Point)
    {
        if (string.IsNullOrEmpty(fontName)) fontName = "Yu Gothic UI";
        return GetCachedFont(fontName, fontSize, style, unit);
    }
