...
public static class FastFont
{
    ...
    public static Font GetDefaultFont() => GetCachedFont("MS UI Gothic");
...
internal static class Program
{
    ...
    static void Main()
    {
        FastFont.SetFormsDefaultFontForBootSpeedUp(null);
        ImageGlass.UI.FastFont2.SetFormsDefaultFontForBootSpeedUp(null);
        ImageGlass.UI.FastFont3.SetFormsDefaultFontForBootSpeedUp(FastFont.CreateFont("MS UI Gothic", fontSize: 9));
